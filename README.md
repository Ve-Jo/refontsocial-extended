...
- Дополнительные PlaceholderAPI-плейсхолдеры для гендера и брака
- SQL-персистентность для marriage/gender данных
- Команды `/marry`, `/gender`, `/sit`, `/lay`
- Расширенный профиль игрока со статусным блоком
...
- `refontsocial.lay.use` — доступ к `/lay`
