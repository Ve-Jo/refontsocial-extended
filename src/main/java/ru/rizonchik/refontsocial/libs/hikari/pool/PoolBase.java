...
import ru.rizonchik.refontsocial.libs.hikari.SQLExceptionOverride;
import ru.rizonchik.refontsocial.libs.hikari.metrics.IMetricsTracker;
import ru.rizonchik.refontsocial.libs.hikari.pool.HikariPool;
...
import ru.rizonchik.refontsocial.libs.hikari.util.DriverDataSource;
import ru.rizonchik.refontsocial.libs.hikari.util.PropertyElf;
    ...
    void handleMBeans(HikariPool hikariPool, boolean register) {
        ...
        try {
            ...
            if ("true".equals(System.getProperty("hikaricp.jmx.register2.0"))) {
                beanConfigName = new ObjectName("ru.rizonchik.refontsocial.libs.hikari:type=PoolConfig,name=" + this.poolName);
                beanPoolName = new ObjectName("ru.rizonchik.refontsocial.libs.hikari:type=Pool,name=" + this.poolName);
            } else {
                beanConfigName = new ObjectName("ru.rizonchik.refontsocial.libs.hikari:type=PoolConfig (" + this.poolName + ")");
                beanPoolName = new ObjectName("ru.rizonchik.refontsocial.libs.hikari:type=Pool (" + this.poolName + ")");
            }
            if (register) {
